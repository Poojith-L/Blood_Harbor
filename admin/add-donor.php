...
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,Password,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status) VALUES(:fullname,:password,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status)";
...
<head>
	...
	<title>Blood Harbor | Admin Add Donor</title>
